...
// tipos de combate: datos de combate Kanto + Johto + Hoenn (386 especies)
enum : uint8_t {
...
struct DexEntry {
  ...
  uint8_t bHp, bAtk, bDef, bSpe;  // base stats Kanto + Johto
...
static const DexEntry DEX_TBL[DEX_COUNT + 1] = {
  ...
  { "PIKACHU", 26, 0, R_COMUN, 0xBCA1, 35, 55, 40, 90, TYPE_ELECTRIC, TYPE_NONE, 0 },  // 25 electric
  ...
  { "NIDORINA", 31, 0, R_EVO, 0x8A73, 70, 62, 67, 56, TYPE_POISON, TYPE_NONE, 0 },  // 30 poison
  ...
  { "NIDORINO", 34, 0, R_EVO, 0x8A73, 61, 72, 57, 65, TYPE_POISON, TYPE_NONE, 0 },  // 33 poison
  { "NIDOKING", 0, 0, R_EVO, 0x8A73, 81, 102, 77, 85, TYPE_POISON, TYPE_GROUND, 0 },  // 34 poison/ground
  { "CLEFAIRY", 36, 0, R_COMUN, 0x8C4D, 70, 45, 48, 35, TYPE_FAIRY, TYPE_NONE, 0 },  // 35 fairy
  { "CLEFABLE", 0, 0, R_EVO, 0x8C4D, 95, 70, 73, 60, TYPE_FAIRY, TYPE_NONE, 0 },  // 36 fairy
  { "VULPIX", 38, 0, R_COMUN, 0xEA87, 38, 41, 40, 65, TYPE_FIRE, TYPE_NONE, 3 },  // 37 fire
  { "NINETALES", 0, 0, R_EVO, 0xEA87, 73, 76, 75, 100, TYPE_FIRE, TYPE_NONE, 3 },  // 38 fire
  { "JIGGLYPUFF", 40, 0, R_COMUN, 0x8C4D, 115, 45, 20, 20, TYPE_NORMAL, TYPE_FAIRY, 0 },  // 39 normal/fairy
  ...
  { "GOLBAT", 169, 0, R_EVO, 0x8A73, 75, 80, 70, 90, TYPE_POISON, TYPE_FLYING, 0 },  // 42 poison/flying
  { "ODDISH", 44, 21, R_COMUN, 0x3C49, 45, 50, 55, 30, TYPE_GRASS, TYPE_POISON, 2 },  // 43 grass/poison
  { "GLOOM", 45, 0, R_EVO, 0x3C49, 60, 65, 70, 40, TYPE_GRASS, TYPE_POISON, 2 },  // 44 grass/poison
  ...
  { "GROWLITHE", 59, 0, R_RARO, 0xEA87, 55, 70, 45, 60, TYPE_FIRE, TYPE_NONE, 3 },  // 58 fire
  ...
  { "POLIWHIRL", 62, 0, R_EVO, 0x4C98, 65, 65, 65, 90, TYPE_WATER, TYPE_NONE, 1 },  // 61 water
  ...
  { "KADABRA", 65, 0, R_EVO, 0xD28F, 40, 35, 30, 105, TYPE_PSYCHIC, TYPE_NONE, 0 },  // 64 psychic
  ...
  { "MACHOKE", 68, 0, R_EVO, 0xA2A5, 80, 100, 70, 45, TYPE_FIGHTING, TYPE_NONE, 0 },  // 67 fighting
  ...
  { "WEEPINBELL", 71, 0, R_EVO, 0x3C49, 65, 90, 50, 55, TYPE_GRASS, TYPE_POISON, 2 },  // 70 grass/poison
  ...
  { "GRAVELER", 76, 0, R_EVO, 0x9407, 55, 95, 115, 35, TYPE_ROCK, TYPE_GROUND, 4 },  // 75 rock/ground
  ...
  { "SHELLDER", 91, 0, R_COMUN, 0x4C98, 30, 65, 100, 40, TYPE_WATER, TYPE_NONE, 1 },  // 90 water
  ...
  { "HAUNTER", 94, 0, R_EVO, 0x6AD3, 45, 50, 45, 95, TYPE_GHOST, TYPE_POISON, 0 },  // 93 ghost/poison
  { "GENGAR", 0, 0, R_EVO, 0x6AD3, 60, 65, 60, 110, TYPE_GHOST, TYPE_POISON, 0 },  // 94 ghost/poison
  { "ONIX", 208, 0, R_RARO, 0x9407, 35, 45, 160, 70, TYPE_ROCK, TYPE_GROUND, 4 },  // 95 rock/ground
  ...
  { "EXEGGCUTE", 103, 0, R_COMUN, 0x3C49, 60, 40, 80, 40, TYPE_GRASS, TYPE_PSYCHIC, 2 },  // 102 grass/psychic
  ...
  { "CHANSEY", 242, 0, R_RARO, 0x8C4D, 250, 5, 5, 50, TYPE_NORMAL, TYPE_NONE, 0 },  // 113 normal
  ...
  { "SEADRA", 230, 0, R_EVO, 0x4C98, 55, 65, 95, 85, TYPE_WATER, TYPE_NONE, 1 },  // 117 water
  ...
  { "STARYU", 121, 0, R_COMUN, 0x4C98, 30, 45, 55, 85, TYPE_WATER, TYPE_NONE, 1 },  // 120 water
  ...
  { "SCYTHER", 212, 0, R_RARO, 0x7CC4, 70, 110, 80, 105, TYPE_BUG, TYPE_FLYING, 2 },  // 123 bug/flying
  ...
  { "EEVEE", 134, 0, R_COMUN, 0x8C4D, 55, 55, 50, 55, TYPE_NORMAL, TYPE_NONE, 0 },  // 133 normal
  ...
  { "PORYGON", 233, 0, R_RARO, 0x8C4D, 65, 60, 70, 40, TYPE_NORMAL, TYPE_NONE, 0 },  // 137 normal
  ...
  { "CHIKORITA", 153, 16, R_COMUN, 0x3C49, 45, 49, 65, 45, TYPE_GRASS, TYPE_NONE, 2 },  // 152 grass
  ...
  { "CYNDAQUIL", 156, 14, R_COMUN, 0xEA87, 39, 52, 43, 65, TYPE_FIRE, TYPE_NONE, 3 },  // 155 fire
  ...
  { "TOTODILE", 159, 18, R_COMUN, 0x4C98, 50, 65, 64, 43, TYPE_WATER, TYPE_NONE, 1 },  // 158 water
  ...
  { "PICHU", 25, 0, R_COMUN, 0xBCA1, 20, 40, 15, 60, TYPE_ELECTRIC, TYPE_NONE, 0 },  // 172 electric
  { "CLEFFA", 35, 0, R_COMUN, 0xDC55, 50, 25, 28, 15, TYPE_FAIRY, TYPE_NONE, 0 },  // 173 fairy
  { "IGGLYBUFF", 39, 0, R_COMUN, 0x8C4D, 90, 30, 15, 15, TYPE_NORMAL, TYPE_FAIRY, 0 },  // 174 normal/fairy
  { "TOGEPI", 176, 0, R_RARO, 0xDC55, 35, 20, 65, 20, TYPE_FAIRY, TYPE_NONE, 0 },  // 175 fairy
  { "TOGETIC", 0, 0, R_EVO, 0xDC55, 55, 40, 85, 40, TYPE_FAIRY, TYPE_FLYING, 0 },  // 176 fairy/flying
  ...
  { "BELLOSSOM", 0, 0, R_EVO, 0x3C49, 75, 80, 95, 50, TYPE_GRASS, TYPE_NONE, 2 },  // 182 grass
  { "MARILL", 184, 18, R_COMUN, 0x4C98, 70, 20, 50, 40, TYPE_WATER, TYPE_FAIRY, 1 },  // 183 water/fairy
  { "AZUMARILL", 0, 0, R_EVO, 0x4C98, 100, 50, 80, 50, TYPE_WATER, TYPE_FAIRY, 1 },  // 184 water/fairy
  { "SUDOWOODO", 0, 0, R_COMUN, 0x9407, 70, 100, 115, 30, TYPE_ROCK, TYPE_NONE, 4 },  // 185 rock
  { "POLITOED", 0, 0, R_EVO, 0x4C98, 90, 75, 75, 70, TYPE_WATER, TYPE_NONE, 1 },  // 186 water
  ...
  { "AIPOM", 0, 0, R_COMUN, 0x8C4D, 55, 70, 55, 85, TYPE_NORMAL, TYPE_NONE, 0 },  // 190 normal
  { "SUNKERN", 192, 0, R_COMUN, 0x3C49, 30, 30, 30, 30, TYPE_GRASS, TYPE_NONE, 2 },  // 191 grass
  ...
  { "ESPEON", 0, 0, R_EVO, 0xD28F, 65, 65, 60, 110, TYPE_PSYCHIC, TYPE_NONE, 0 },  // 196 psychic
  { "UMBREON", 0, 0, R_EVO, 0x5249, 95, 65, 110, 65, TYPE_DARK, TYPE_NONE, 0 },  // 197 dark
  { "MURKROW", 0, 0, R_COMUN, 0x5249, 60, 85, 42, 91, TYPE_DARK, TYPE_FLYING, 0 },  // 198 dark/flying
  { "SLOWKING", 0, 0, R_EVO, 0x4C98, 95, 75, 80, 30, TYPE_WATER, TYPE_PSYCHIC, 1 },  // 199 water/psychic
  { "MISDREAVUS", 0, 0, R_COMUN, 0x6AD3, 60, 60, 60, 85, TYPE_GHOST, TYPE_NONE, 0 },  // 200 ghost
  { "UNOWN", 0, 0, R_RARO, 0xD28F, 48, 72, 48, 48, TYPE_PSYCHIC, TYPE_NONE, 0 },  // 201 psychic
  { "WOBBUFFET", 0, 0, R_RARO, 0xD28F, 190, 33, 58, 33, TYPE_PSYCHIC, TYPE_NONE, 0 },  // 202 psychic
  ...
  { "DUNSPARCE", 0, 0, R_RARO, 0x8C4D, 100, 70, 70, 45, TYPE_NORMAL, TYPE_NONE, 0 },  // 206 normal
  { "GLIGAR", 0, 0, R_COMUN, 0xB447, 65, 75, 105, 85, TYPE_GROUND, TYPE_FLYING, 4 },  // 207 ground/flying
  { "STEELIX", 0, 0, R_EVO, 0x8CB4, 75, 85, 200, 30, TYPE_STEEL, TYPE_GROUND, 0 },  // 208 steel/ground
  { "SNUBBULL", 210, 23, R_COMUN, 0xDC55, 60, 80, 50, 30, TYPE_FAIRY, TYPE_NONE, 0 },  // 209 fairy
  { "GRANBULL", 0, 0, R_EVO, 0xDC55, 90, 120, 75, 45, TYPE_FAIRY, TYPE_NONE, 0 },  // 210 fairy
  { "QWILFISH", 0, 0, R_COMUN, 0x4C98, 65, 95, 85, 85, TYPE_WATER, TYPE_POISON, 1 },  // 211 water/poison
  ...
  { "SNEASEL", 0, 0, R_RARO, 0x5249, 55, 95, 55, 115, TYPE_DARK, TYPE_ICE, 0 },  // 215 dark/ice
  ...
  { "CORSOLA", 0, 0, R_RARO, 0x4C98, 65, 55, 95, 35, TYPE_WATER, TYPE_ROCK, 1 },  // 222 water/rock
  ...
  { "MANTINE", 0, 0, R_COMUN, 0x4C98, 85, 40, 70, 70, TYPE_WATER, TYPE_FLYING, 1 },  // 226 water/flying
  { "SKARMORY", 0, 0, R_RARO, 0x8CB4, 65, 80, 140, 70, TYPE_STEEL, TYPE_FLYING, 0 },  // 227 steel/flying
  { "HOUNDOUR", 229, 24, R_COMUN, 0x5249, 45, 60, 30, 65, TYPE_DARK, TYPE_FIRE, 0 },  // 228 dark/fire
  { "HOUNDOOM", 0, 0, R_EVO, 0x5249, 75, 90, 50, 95, TYPE_DARK, TYPE_FIRE, 0 },  // 229 dark/fire
  ...
  { "TYROGUE", 237, 20, R_COMUN, 0xA2A5, 35, 35, 35, 35, TYPE_FIGHTING, TYPE_NONE, 0 },  // 236 fighting
  { "HITMONTOP", 0, 0, R_EVO, 0xA2A5, 50, 95, 95, 70, TYPE_FIGHTING, TYPE_NONE, 0 },  // 237 fighting
  { "SMOOCHUM", 124, 20, R_COMUN, 0x4DB8, 45, 30, 15, 65, TYPE_ICE, TYPE_PSYCHIC, 5 },  // 238 ice/psychic
  { "ELEKID", 125, 20, R_COMUN, 0xBCA1, 45, 63, 37, 95, TYPE_ELECTRIC, TYPE_NONE, 0 },  // 239 electric
  { "MAGBY", 126, 20, R_COMUN, 0xEA87, 45, 75, 37, 83, TYPE_FIRE, TYPE_NONE, 3 },  // 240 fire
  ...
  { "TREECKO", 253, 16, R_COMUN, 0x3C49, 40, 45, 35, 70, TYPE_GRASS, TYPE_NONE, 2 },  // 252 grass
  ...
  { "TORCHIC", 256, 16, R_COMUN, 0xEA87, 45, 60, 40, 45, TYPE_FIRE, TYPE_NONE, 3 },  // 255 fire
  ...
  { "MUDKIP", 259, 16, R_COMUN, 0x4C98, 50, 70, 50, 40, TYPE_WATER, TYPE_NONE, 1 },  // 258 water
  ...
  { "POOCHYENA", 262, 18, R_COMUN, 0x5249, 35, 55, 35, 35, TYPE_DARK, TYPE_NONE, 0 },  // 261 dark
  { "MIGHTYENA", 0, 0, R_EVO, 0x5249, 70, 90, 70, 70, TYPE_DARK, TYPE_NONE, 0 },  // 262 dark
  ...
  { "CASCOON", 269, 10, R_EVO, 0x7CC4, 50, 35, 55, 15, TYPE_BUG, TYPE_NONE, 2 },  // 268 bug
  ...
  { "LOMBRE", 272, 0, R_EVO, 0x4C98, 60, 50, 50, 50, TYPE_WATER, TYPE_GRASS, 1 },  // 271 water/grass
  ...
  { "NUZLEAF", 275, 0, R_EVO, 0x3C49, 70, 70, 40, 60, TYPE_GRASS, TYPE_DARK, 2 },  // 274 grass/dark
  ...
  { "MASQUERAIN", 0, 0, R_EVO, 0x7CC4, 70, 60, 62, 60, TYPE_BUG, TYPE_FLYING, 2 },  // 284 bug/flying
  ...
  { "SHEDINJA", 0, 0, R_COMUN, 0x7CC4, 1, 90, 45, 40, TYPE_BUG, TYPE_GHOST, 2 },  // 292 bug/ghost
  ...
  { "AZURILL", 183, 0, R_COMUN, 0x8C4D, 50, 20, 40, 20, TYPE_NORMAL, TYPE_FAIRY, 0 },  // 298 normal/fairy
  { "NOSEPASS", 0, 0, R_COMUN, 0x9407, 30, 45, 135, 30, TYPE_ROCK, TYPE_NONE, 4 },  // 299 rock
  { "SKITTY", 301, 0, R_COMUN, 0x8C4D, 50, 45, 45, 50, TYPE_NORMAL, TYPE_NONE, 0 },  // 300 normal
  { "DELCATTY", 0, 0, R_EVO, 0x8C4D, 70, 65, 65, 70, TYPE_NORMAL, TYPE_NONE, 0 },  // 301 normal
  { "SABLEYE", 0, 0, R_RARO, 0x5249, 50, 75, 75, 50, TYPE_DARK, TYPE_GHOST, 0 },  // 302 dark/ghost
  { "MAWILE", 0, 0, R_RARO, 0x8CB4, 50, 85, 85, 50, TYPE_STEEL, TYPE_FAIRY, 0 },  // 303 steel/fairy
  { "ARON", 305, 32, R_COMUN, 0x8CB4, 50, 70, 100, 30, TYPE_STEEL, TYPE_ROCK, 0 },  // 304 steel/rock
  { "LAIRON", 306, 42, R_EVO, 0x8CB4, 60, 90, 140, 40, TYPE_STEEL, TYPE_ROCK, 0 },  // 305 steel/rock
  { "AGGRON", 0, 0, R_EVO, 0x8CB4, 70, 110, 180, 50, TYPE_STEEL, TYPE_ROCK, 0 },  // 306 steel/rock
  ...
  { "PLUSLE", 0, 0, R_RARO, 0xBCA1, 60, 50, 40, 95, TYPE_ELECTRIC, TYPE_NONE, 0 },  // 311 electric
  { "MINUN", 0, 0, R_RARO, 0xBCA1, 60, 40, 50, 95, TYPE_ELECTRIC, TYPE_NONE, 0 },  // 312 electric
  { "VOLBEAT", 0, 0, R_RARO, 0x7CC4, 65, 73, 55, 85, TYPE_BUG, TYPE_NONE, 2 },  // 313 bug
  { "ILLUMISE", 0, 0, R_RARO, 0x7CC4, 65, 47, 55, 85, TYPE_BUG, TYPE_NONE, 2 },  // 314 bug
  { "ROSELIA", 0, 0, R_COMUN, 0x3C49, 50, 60, 45, 65, TYPE_GRASS, TYPE_POISON, 2 },  // 315 grass/poison
  ...
  { "TORKOAL", 0, 0, R_RARO, 0xEA87, 70, 85, 140, 20, TYPE_FIRE, TYPE_NONE, 3 },  // 324 fire
  ...
  { "SPINDA", 0, 0, R_RARO, 0x8C4D, 60, 60, 60, 60, TYPE_NORMAL, TYPE_NONE, 0 },  // 327 normal
  ...
  { "ALTARIA", 0, 0, R_EVO, 0x5A5A, 75, 70, 90, 80, TYPE_DRAGON, TYPE_FLYING, 0 },  // 334 dragon/flying
  { "ZANGOOSE", 0, 0, R_RARO, 0x8C4D, 73, 115, 60, 90, TYPE_NORMAL, TYPE_NONE, 0 },  // 335 normal
  { "SEVIPER", 0, 0, R_RARO, 0x8A73, 73, 100, 60, 65, TYPE_POISON, TYPE_NONE, 0 },  // 336 poison
  { "LUNATONE", 0, 0, R_RARO, 0x9407, 70, 55, 65, 70, TYPE_ROCK, TYPE_PSYCHIC, 4 },  // 337 rock/psychic
  { "SOLROCK", 0, 0, R_RARO, 0x9407, 70, 95, 85, 70, TYPE_ROCK, TYPE_PSYCHIC, 4 },  // 338 rock/psychic
  ...
  { "LILEEP", 346, 40, R_COMUN, 0x9407, 66, 41, 77, 23, TYPE_ROCK, TYPE_GRASS, 4 },  // 345 rock/grass
  { "CRADILY", 0, 0, R_EVO, 0x9407, 86, 81, 97, 43, TYPE_ROCK, TYPE_GRASS, 4 },  // 346 rock/grass
  { "ANORITH", 348, 40, R_COMUN, 0x9407, 45, 95, 50, 75, TYPE_ROCK, TYPE_BUG, 4 },  // 347 rock/bug
  { "ARMALDO", 0, 0, R_EVO, 0x9407, 75, 125, 100, 45, TYPE_ROCK, TYPE_BUG, 4 },  // 348 rock/bug
  { "FEEBAS", 350, 0, R_COMUN, 0x4C98, 20, 15, 20, 80, TYPE_WATER, TYPE_NONE, 1 },  // 349 water
  ...
  { "KECLEON", 0, 0, R_RARO, 0x8C4D, 60, 90, 70, 40, TYPE_NORMAL, TYPE_NONE, 0 },  // 352 normal
  ...
  { "TROPIUS", 0, 0, R_RARO, 0x3C49, 99, 68, 83, 51, TYPE_GRASS, TYPE_FLYING, 2 },  // 357 grass/flying
  { "CHIMECHO", 0, 0, R_RARO, 0xD28F, 65, 50, 70, 65, TYPE_PSYCHIC, TYPE_NONE, 0 },  // 358 psychic
  { "ABSOL", 0, 0, R_RARO, 0x5249, 65, 130, 60, 75, TYPE_DARK, TYPE_NONE, 0 },  // 359 dark
  { "WYNAUT", 202, 20, R_COMUN, 0xD28F, 95, 23, 48, 23, TYPE_PSYCHIC, TYPE_NONE, 0 },  // 360 psychic
  ...
  { "CLAMPERL", 367, 0, R_COMUN, 0x4C98, 35, 64, 85, 32, TYPE_WATER, TYPE_NONE, 1 },  // 366 water
  { "HUNTAIL", 0, 0, R_EVO, 0x4C98, 55, 104, 105, 52, TYPE_WATER, TYPE_NONE, 1 },  // 367 water
  { "GOREBYSS", 0, 0, R_EVO, 0x4C98, 55, 84, 105, 52, TYPE_WATER, TYPE_NONE, 1 },  // 368 water
  { "RELICANTH", 0, 0, R_RARO, 0x4C98, 100, 90, 130, 55, TYPE_WATER, TYPE_ROCK, 1 },  // 369 water/rock
  { "LUVDISC", 0, 0, R_RARO, 0x4C98, 43, 30, 55, 97, TYPE_WATER, TYPE_NONE, 1 },  // 370 water
  { "BAGON", 372, 30, R_RARO, 0x5A5A, 45, 75, 60, 50, TYPE_DRAGON, TYPE_NONE, 0 },  // 371 dragon
  { "SHELGON", 373, 50, R_EVO, 0x5A5A, 65, 95, 100, 50, TYPE_DRAGON, TYPE_NONE, 0 },  // 372 dragon
  { "SALAMENCE", 0, 0, R_EVO, 0x5A5A, 95, 135, 80, 100, TYPE_DRAGON, TYPE_FLYING, 0 },  // 373 dragon/flying
  { "BELDUM", 375, 20, R_RARO, 0x8CB4, 40, 55, 80, 30, TYPE_STEEL, TYPE_PSYCHIC, 0 },  // 374 steel/psychic
  { "METANG", 376, 45, R_EVO, 0x8CB4, 60, 75, 100, 50, TYPE_STEEL, TYPE_PSYCHIC, 0 },  // 375 steel/psychic
  { "METAGROSS", 0, 0, R_EVO, 0x8CB4, 80, 135, 130, 70, TYPE_STEEL, TYPE_PSYCHIC, 0 },  // 376 steel/psychic
  ...
  { "REGISTEEL", 0, 0, R_LEGENDARIO, 0x8CB4, 80, 75, 150, 50, TYPE_STEEL, TYPE_NONE, 0 },  // 379 steel
  { "LATIAS", 0, 0, R_LEGENDARIO, 0x5A5A, 80, 80, 90, 110, TYPE_DRAGON, TYPE_PSYCHIC, 0 },  // 380 dragon/psychic
  { "LATIOS", 0, 0, R_LEGENDARIO, 0x5A5A, 80, 90, 80, 110, TYPE_DRAGON, TYPE_PSYCHIC, 0 },  // 381 dragon/psychic
...
static const int16_t CLASSIC_DEX[] = { 1, 4, 7, 152, 155, 158, 252, 255, 258 };
#define NUM_CLASSIC_DEX 9
