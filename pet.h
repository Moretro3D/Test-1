...
public:
  ...
  void chooseStarter(int16_t dex) {
    switch (dex) {
      ...
      case 152: case 155: case 158:
      case 252: case 255: case 258:
        // Le premier Pokemon est cree directement : aucun oeuf, aucun delai
        // et aucune possibilite qu'une espece aleatoire remplace le choix.
        speciesId = dex;
        prevSpeciesId = -1;
        eggTarget = dex;
        eggTaps = 0;
        ...
        return;
      default:
        return; // Evoli et toute autre espece sont refuses comme starter.
    }
  }
