...
def check(value, label):
    if not value:
        raise SystemExit("ECHEC V9.18: " + label)
    print("OK  ", label)
...
check(manifest["name"] == "PokeTama Moretro3D - V9.18", "manifest Moretro3D")
check(manifest["version"] == "1.43.0-moretro3d-v9.18-onboarding", "version Web coherente")
check('VERSION="1.43.0-moretro3d-v9.18-onboarding"' in build, "version de compilation coherente")
...
print("AUDIT MORETRO3D V9.18 OK")
