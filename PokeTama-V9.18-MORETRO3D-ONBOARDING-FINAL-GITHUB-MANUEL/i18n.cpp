...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "ELIGE GENERACION", "GENERACION %u", "ELEGIR", "TOCA UNA POKEBALL", "TU INICIAL", "CONFIRMAR",
    "NORMAL", "PS",
    "SONIDO", "AHORRO", "PANTALLA", "MODO",
    "JUEGO LOCAL", "CONEXION LOCAL", "CREAR SALA", "UNIRSE", "INTERCAMBIO", "COMBATE",
    "BUSCANDO...", "CONECTADO", "CANCELAR", "CONFIRMAR", "LISTO", "VOLVER",
    "AJUSTES", "OSCURO", "CLARO", "SI", "NO",
    "NINGUNO", "CLASICO", "POKEBALL", "ORO", "PLATA", "NEON",
    "MARCOS DESBLOQUEADOS EN LA POKEDEX", "EVOLUCION ESPECIAL", "ACTIVO", "CUIDAR",
  },
  // ---------------- EN ----------------
  {
    ...
    "CHOOSE GENERATION", "GENERATION %u", "CHOOSE", "TAP A POKEBALL", "YOUR STARTER", "CONFIRM",
    "NORMAL", "HP",
    "SOUND", "POWER SAVE", "DISPLAY", "MODE",
    "LOCAL PLAY", "LOCAL CONNECTION", "HOST ROOM", "JOIN ROOM", "TRADE", "BATTLE",
    "SEARCHING...", "CONNECTED", "CANCEL", "CONFIRM", "READY", "BACK",
    "SETTINGS", "DARK", "LIGHT", "ON", "OFF",
    "NONE", "CLASSIC", "POKEBALL", "GOLD", "SILVER", "NEON",
    "FRAMES UNLOCKED THROUGH THE POKEDEX", "SPECIAL EVOLUTION", "ACTIVE", "CARE",
  },
  // ---------------- FR ----------------
  {
    ...
    "CHOISIS LA GENERATION", "GENERATION %u", "CHOISIR", "TOUCHE UNE POKEBALL", "TON STARTER", "VALIDER",
    "NORMALE", "PV",
    "SON", "ECONOMIE", "AFFICHAGE", "MODE",
    "JEU LOCAL", "CONNEXION LOCALE", "CREER SALON", "REJOINDRE", "ECHANGE", "COMBAT",
    "RECHERCHE...", "CONNECTE", "ANNULER", "CONFIRMER", "PRET", "RETOUR",
    "REGLAGES", "SOMBRE", "CLAIR", "OUI", "NON",
    "AUCUN", "CLASSIQUE", "POKEBALL", "OR", "ARGENT", "NEON",
    "CADRES DEBLOQUES VIA LE POKEDEX", "EVOLUTION SPECIALE", "ACTIF", "S'OCCUPER",
  },
  // ---------------- DE ----------------
  {
    ...
    "GENERATION WAEHLEN", "GENERATION %u", "WAEHLEN", "POKEBALL ANTIPPEN", "DEIN STARTER", "BESTAETIGEN",
    "NORMAL", "KP",
    "TON", "ENERGIESPAREN", "ANZEIGE", "MODUS",
    "LOKALES SPIEL", "LOKALE VERBINDUNG", "RAUM OEFFNEN", "BEITRETEN", "TAUSCH", "KAMPF",
    "SUCHE...", "VERBUNDEN", "ABBRECHEN", "BESTAETIGEN", "BEREIT", "ZURUECK",
    "EINSTELLUNGEN", "DUNKEL", "HELL", "AN", "AUS",
    "KEINER", "KLASSISCH", "POKEBALL", "GOLD", "SILBER", "NEON",
    "RAHMEN UEBER DEN POKEDEX FREISCHALTEN", "SPEZIELLE ENTWICKLUNG", "AKTIV", "PFLEGEN",
  },
  // ---------------- IT ----------------
  {
    ...
    "SCEGLI GENERAZIONE", "GENERAZIONE %u", "SCEGLI", "TOCCA UNA POKEBALL", "IL TUO INIZIALE", "CONFERMA",
    "NORMALE", "PS",
    "AUDIO", "RISPARMIO", "SCHERMO", "MODALITA",
    "GIOCO LOCALE", "CONNESSIONE LOCALE", "CREA STANZA", "UNISCITI", "SCAMBIO", "LOTTA",
    "RICERCA...", "CONNESSO", "ANNULLA", "CONFERMA", "PRONTO", "INDIETRO",
    "IMPOSTAZIONI", "SCURO", "CHIARO", "SI", "NO",
    "NESSUNO", "CLASSICO", "POKEBALL", "ORO", "ARGENTO", "NEON",
    "CORNICI SBLOCCATE TRAMITE IL POKEDEX", "EVOLUZIONE SPECIALE", "ATTIVO", "CURA",
  },
  // ---------------- PT ----------------
  {
    ...
    "ESCOLHA A GERACAO", "GERACAO %u", "ESCOLHER", "TOQUE NUMA POKEBOLA", "SEU INICIAL", "CONFIRMAR",
    "NORMAL", "PS",
    "SOM", "POUPANCA", "TELA", "MODO",
    "JOGO LOCAL", "CONEXAO LOCAL", "CRIAR SALA", "ENTRAR", "TROCA", "BATALHA",
    "PROCURANDO...", "CONECTADO", "CANCELAR", "CONFIRMAR", "PRONTO", "VOLTAR",
    "DEFINICOES", "ESCURO", "CLARO", "SIM", "NAO",
    "NENHUM", "CLASSICO", "POKEBALL", "OURO", "PRATA", "NEON",
    "MOLDURAS DESBLOQUEADAS PELO POKEDEX", "EVOLUCAO ESPECIAL", "ATIVO", "CUIDAR",
  },
};
