...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "TODOS",
    "EFECTIVO", "DEBIL",
    "CAJA", "SIN CAPTURAS", "CAPTURADOS %u/251",
    "FELIZ!", "VINC +1", "ESPERA",
    "MANANA", "DIA", "TARDE", "NOCHE",
    "META DEX %u", "BONUS DEX", "CONOCIDOS %u/251",
    "DEX", "TIPO", "CRIADO", "%u/%u",
    "CERCA!",
  ...
  // ---------------- EN ----------------
  {
    ...
    "ALL",
    "EFFECTIVE", "WEAK",
    "BOX", "NO CATCHES", "CAUGHT %u/251",
    "HAPPY!", "BOND +1", "WAIT",
    "MORNING", "DAY", "EVENING", "NIGHT",
    "DEX GOAL %u", "DEX REWARD", "KNOWN %u/251",
    "DEX", "TYPE", "RAISED", "%u/%u",
    "CLOSE!",
  ...
  // ---------------- FR ----------------
  {
    ...
    "TOUS",
    "EFFICACE", "FAIBLE",
    "BOITE", "AUCUNE PRISE", "CAPTURES %u/251",
    "HEUREUX!", "LIEN +1", "ATTENDS",
    "MATIN", "JOUR", "SOIR", "NUIT",
    "BUT DEX %u", "BONUS DEX", "CONNUS %u/251",
    "DEX", "TYPE", "ELEVE", "%u/%u",
    "PRESQUE!",
  ...
  // ---------------- DE ----------------
  {
    ...
    "ALLE",
    "EFFEKTIV", "SCHWACH",
    "BOX", "KEINE FAENGE", "GEFANGEN %u/251",
    "FROH!", "BND +1", "WARTEN",
    "MORGEN", "TAG", "ABEND", "NACHT",
    "DEX ZIEL %u", "DEX BONUS", "BEKANNT %u/251",
    "DEX", "TYP", "AUFZ.", "%u/%u",
    "KNAPP!",
  ...
  // ---------------- IT ----------------
  {
    ...
    "TUTTI",
    "EFFICACE", "DEBOLE",
    "BOX", "NESSUNA PRESA", "PRESI %u/251",
    "FELICE!", "LEG +1", "ASPETTA",
    "MATTINA", "GIORNO", "SERA", "NOTTE",
    "OBIETTIVO DEX %u", "BONUS DEX", "VISTI %u/251",
    "DEX", "TIPO", "ALLEV.", "%u/%u",
    "QUASI!",
  ...
  // ---------------- PT ----------------
  {
    ...
    "TODOS",
    "EFETIVO", "FRACO",
    "CAIXA", "SEM CAPTURAS", "APANHADOS %u/251",
    "FELIZ!", "LACO +1", "ESPERA",
    "MANHA", "DIA", "TARDE", "NOITE",
    "META DEX %u", "BONUS DEX", "CONHECIDOS %u/251",
    "DEX", "TIPO", "CRIADO", "%u/%u",
    "PERTO!",
