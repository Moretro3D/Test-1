...
def heart():
    # Coeur 32x32 dessine pixel par pixel : lobes compacts, creux central
    # marque et pointe en escalier. Le contour sombre evite l'effet Mickey.
    g = G()
    outer = {
        6: [(8, 13), (18, 23)],
        7: [(6, 15), (16, 25)],
        8: [(5, 26)], 9: [(4, 27)], 10: [(4, 27)],
        11: [(4, 27)], 12: [(5, 26)], 13: [(5, 26)],
        14: [(6, 25)], 15: [(6, 25)], 16: [(7, 24)],
        17: [(8, 23)], 18: [(8, 23)], 19: [(9, 22)],
        20: [(10, 21)], 21: [(11, 20)], 22: [(12, 19)],
        23: [(13, 18)], 24: [(14, 17)], 25: [(15, 16)],
    }
    for y, spans in outer.items():
        for x1, x2 in spans: g.rect(x1, y, x2, y, 'k')
    inner = {
        7: [(8, 13), (18, 23)], 8: [(7, 24)],
        9: [(6, 25)], 10: [(6, 25)], 11: [(6, 25)],
        12: [(7, 24)], 13: [(7, 24)], 14: [(8, 23)],
        15: [(8, 23)], 16: [(9, 22)], 17: [(10, 21)],
        18: [(10, 21)], 19: [(11, 20)], 20: [(12, 19)],
        21: [(13, 18)], 22: [(14, 17)], 23: [(15, 16)],
    }
    for y, spans in inner.items():
        for x1, x2 in spans: g.rect(x1, y, x2, y, 'r')
    # Ombre bordeaux sur le bord droit et reflet blanc en deux pixels nets.
    for y, x1, x2 in [(9,23,24),(10,24,25),(11,24,25),(12,23,24),
                       (13,23,24),(14,22,23),(15,22,23),(16,21,22),
                       (17,20,21),(18,20,21),(19,19,20),(20,18,19)]:
        g.rect(x1, y, x2, y, 'R')
    g.rect(8, 9, 10, 10, 'w'); g.px(7, 11, 'w')
    return g.rows()
