...
enum StrId : uint8_t {
  ...
  // écrans ajoutés : starter, réglages et réseau local
  S_CHOOSE_GENERATION, S_GENERATION_FMT, S_CHOOSE, S_TOUCH_POKEBALL, S_YOUR_STARTER, S_VALIDATE,
  S_NORMAL_ATTACK, S_HP,
  S_SOUND_LABEL, S_POWER_SAVE_LABEL, S_DISPLAY_LABEL, S_MODE_LABEL,
  S_LOCAL_PLAY, S_LAN_TITLE, S_LAN_HOST, S_LAN_JOIN, S_LAN_TRADE, S_LAN_BATTLE,
  S_LAN_SEARCHING, S_LAN_CONNECTED, S_LAN_CANCEL, S_LAN_CONFIRM, S_LAN_READY, S_LAN_BACK,
  // textes des pages qui etaient encore ecrits directement dans le rendu
  S_SETTINGS, S_DARK, S_LIGHT, S_ON, S_OFF,
  S_FRAME_NONE, S_FRAME_CLASSIC, S_FRAME_POKEBALL, S_FRAME_GOLD, S_FRAME_SILVER, S_FRAME_NEON,
  S_FRAME_UNLOCK_HINT, S_SPECIAL_EVOLUTION, S_ACTIVE, S_CARE_ACTION,
  STR_COUNT
};
